# Privacy Policy for MmmDining

Effective Date: May 5, 2026

MmmDining is a Wear OS app developed by me, Isaac Wheeler ("Altavision"). The app lets users view University of Michigan dining menus from their watch.

This Privacy Policy explains what information MmmDining collects, uses, stores, and shares.

MmmDining does not collect personal information, does not use analytics, does not show ads, and does not require users to create or log in to any account.

## Information We Collect

MmmDining does not collect, store, or share personal information.

The app does not:

* Require users to create an account
* Ask users to log in
* Collect names, email addresses, phone numbers, or other personal identifiers
...
These requests are sent to Michigan Dining servers so the app can display current dining hall menus. MmmDining does not use these requests to identify users, track users, or build user profiles.
...
MmmDining does not use third-party analytics, advertising, tracking, or authentication services. The app does not include additional third-party libraries or SDKs beyond standard Android/Wear OS components.
...
Altavision
E-mail: justanothertacocat [at] outlook [dot] com
